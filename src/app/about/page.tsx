        ...
        <section className="col-span-2" id="whychooseus">
          ...
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
            ...
            <li>
              ...
              industries Health, Manufacturing, entertainment, Education,
              Energy, Logistics
            </li>
          ...
          <p className="leading-7 [&:not(:first-child)]:my-6">
            ...
            introduction of economics, business and accounting gives your child
            a distinct tool to start exercising daily commerce decisions at
            their level.
          </p>
        </section>
          ...
          <div>
            ...
            <p className="text-xl text-muted-foreground">
              ...
              <em className="font-semibold text-primary">
                Grade 8-12 IEB and CAPS
              </em>{" "}
              . This will be achieved through providing classes and tutoring
              sessions to learners who wish to obtain academic excellence.
            </p>
          </div>
          <div className="">
